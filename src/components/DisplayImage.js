...
const DisplayImage = ({
    ...
    return (
        <div className='fixed top-0 left-0 bottom-0 right-0 bg-slate-200 bg-opacity-70 flex justify-center items-center'>
            <div className='bg-white shadow-lg rounded p-4 max-w-5xl  relative '>

                <div className='flex justify-center items-center p-4 max-h-[70vh] max-w-[70vh]'>
